...
public class GitHubDownloadWebPageTool {

    public static IEnumerator MakeRequest(TextDownloadedByCoroutine jsonTextRecovered, string urlOfRequest, I_OwnGitHubAuthPrivateApiKeyGet authToken) { 
    
        yield return MakeRequest(jsonTextRecovered, urlOfRequest, authToken.GetGitHubAuthPrivateApiKey());
    }
